...
# MAGIC %md
# MAGIC ### LLM SERVING (LLAMA-3.1-8B-INSTRUCT)

# COMMAND ----------

# MAGIC %pip install --upgrade --quiet "mlflow-skinny[databricks]>=2.4.1" safetensors torch transformers
...
# MAGIC %md
# MAGIC ### GET MODEL FROM HUGGING FACE
...
# mlflow.set_experiment('/Users/{}/semmanuel-llama2-7b-hf-chat'.format(<experiment_name>))
