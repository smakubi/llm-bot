...
# MAGIC %md 
# MAGIC ### INIT ADVANCED SETTING UP BACKEND. 
# MAGIC
# MAGIC This notebook contains import and helper functions for the workshop.
# MAGIC
...
# MAGIC %md
# MAGIC ### FILE DOWNLOAD AND UPLOAD FUNCTIONS
...
def upload_pdfs_to_volume(volume_path):
  download_file_from_git(volume_path, "smakubi", "sophinea-pdf", "/PDFs")
